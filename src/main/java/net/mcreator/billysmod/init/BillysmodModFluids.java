...
import net.mcreator.billysmod.fluid.QuicksandFluid;
import net.mcreator.billysmod.BillysmodMod;

public class BillysmodModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, BillysmodMod.MODID);
