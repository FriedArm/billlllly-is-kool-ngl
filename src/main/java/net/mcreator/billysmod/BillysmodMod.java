 ...
 *
 */
package net.mcreator.billysmod;
...
@Mod("billysmod")
public class BillysmodMod {
	public static final Logger LOGGER = LogManager.getLogger(BillysmodMod.class);
	public static final String MODID = "billysmod";
