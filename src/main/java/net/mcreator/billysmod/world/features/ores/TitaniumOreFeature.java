...
public class TitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("billysmod:titanium_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), BillysmodModBlocks.TITANIUM_ORE.get().defaultBlockState())), 7));
		PLACED_FEATURE = PlacementUtils.register("billysmod:titanium_ore", CONFIGURED_FEATURE,
