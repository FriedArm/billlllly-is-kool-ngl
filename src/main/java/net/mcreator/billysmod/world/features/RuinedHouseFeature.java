...
public class RuinedHouseFeature extends Feature<NoneFeatureConfiguration> {
	public static RuinedHouseFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new RuinedHouseFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("billysmod:ruined_house", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("billysmod:ruined_house", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
